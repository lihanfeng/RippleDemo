...
//  LSDemo
//
//  Created by hanfeng.li on 2017/5/18.
...
@interface LSRippleButton ()
@property (nonatomic, strong) CALayer *rippleLayer;
@end

@implementation LSRippleButton
...
- (CALayer *)rippleLayer {
    if (_rippleLayer == nil) {
        ...
        _rippleLayer.position = CGPointMake(0, self.layer.bounds.size.height / 2);
